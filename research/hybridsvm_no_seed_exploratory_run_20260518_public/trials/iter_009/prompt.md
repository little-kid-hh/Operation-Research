...
- active feature names: `spare_cap_sq`, `spare_cap_x_conc`, `spare_cap_x_wl_total`, `vol_top3_share`, `n_high_asr_items`, `spare_cap_log1p`, `h_to_H_max_sq`, `l_std_x_h_max`, `max_fp_ratio`, `spare_cap_x_wl_max`, `wl_total_over_wl_max`, `max_dim_l_to_vL`, `spare_cap_x_sku_counts`, `n_items_near_vL`, `n_tall_items`
- active bank AUC: `0.9730`
- active bank TPR@FPR=1%: `0.7026`
- active bank Accuracy: `0.9308`

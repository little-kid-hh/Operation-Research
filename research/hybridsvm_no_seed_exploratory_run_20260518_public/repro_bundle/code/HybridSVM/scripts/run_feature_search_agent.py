...
DEFAULT_AGG = BUNDLE_ROOT / "data" / "training_2orientations.csv"
DEFAULT_ITEMS = BUNDLE_ROOT / "data" / "物品信息和dblf信息.csv"
DEFAULT_ROOT = BUNDLE_ROOT / "generated_feature_search_runs"
DEFAULT_TREE_GUIDANCE = BUNDLE_ROOT / "guidance" / "XGB_GUIDED_FEATURE_HYPOTHESES_BASE40.md"

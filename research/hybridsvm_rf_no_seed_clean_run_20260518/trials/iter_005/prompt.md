...
- active feature names: `spare_cap_x_wl_total`, `spare_cap_x_sku_counts`, `spare_cap_sq`, `hH_x_lL`, `big_piece_share`, `spare_cap_x_wl_max`, `item_vol_cv`, `long_item_share`
- active bank AUC: `0.9704`
- active bank TPR@FPR=1%: `0.7070`
- active bank Accuracy: `0.9284`

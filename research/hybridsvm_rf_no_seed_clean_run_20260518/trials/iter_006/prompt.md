...
- active feature names: `spare_cap_x_wl_total`, `spare_cap_x_sku_counts`, `spare_cap_sq`, `hH_x_lL`, `big_piece_share`, `spare_cap_x_wl_max`, `item_vol_cv`, `long_item_share`, `wl_cv`, `fragile_share`, `spare_cap_cubed`
- active bank AUC: `0.9711`
- active bank TPR@FPR=1%: `0.6957`

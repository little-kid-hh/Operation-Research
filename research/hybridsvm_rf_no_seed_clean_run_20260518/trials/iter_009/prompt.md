...
- iter `5`: AUC `0.9711` (Δ `+0.0059`), TPR@1% `0.6957` (Δ `+0.0610`), features=wl_cv, fragile_share, spare_cap_cubed
- iter `3`: AUC `0.9704` (Δ `+0.0053`), TPR@1% `0.7070` (Δ `+0.0723`), features=spare_cap_x_wl_max, item_vol_cv, long_item_share
...
- source accepted trials: `1`, `3`, `5`, `6`
- active feature count: `14`
- active feature names: `spare_cap_x_wl_total`, `spare_cap_x_sku_counts`, `spare_cap_sq`, `hH_x_lL`, `big_piece_share`, `spare_cap_x_wl_max`, `item_vol_cv`, `long_item_share`, `wl_cv`, `fragile_share`, `spare_cap_cubed`, `wl_max_to_avg`, `tight_x_high_wl`, `sku_counts_x_lL`
- active bank AUC: `0.9714`
- active bank TPR@FPR=1%: `0.7040`

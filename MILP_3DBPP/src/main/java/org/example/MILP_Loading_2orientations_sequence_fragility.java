...
public class MILP_Loading_2orientations_sequence_fragility {
...
//            System.out.println("SequenceMax: "+SequenceMax);
            ...
            for (int i = 0; i < numParcels; ++i) {
                for (int k = 0; k < numParcels; ++k) {
                    ...
                    model.addConstr(uzp.get(i).get(k), GRB.LESS_EQUAL, expr1, "c_42_"+i+"_"+k);

                    GRBLinExpr expr2 = new GRBLinExpr();
                    expr2.addTerm(-1.0, z.get(i)); // z.get(i)
                    expr2.addTerm(1.0, zr.get(k)); // z.get(i)
                    expr2.addTerm(2*H_max, azp.get(i).get(k));
                    model.addConstr(uzp.get(i).get(k), GRB.LESS_EQUAL, expr2, "c_43_"+i+"_"+k);
                    ...
                    model.addConstr(expr2_5, GRB.LESS_EQUAL, uzp.get(i).get(k), "c_44_"+i+"_"+k);
                    GRBLinExpr expr3 = new GRBLinExpr();
                    expr3.addConstant(H_max);
                    expr3.addTerm(-H_max,Azp.get(i).get(k));
                    model.addConstr(expr3, GRB.GREATER_EQUAL, uzp.get(i).get(k), "c_45_"+i+"_"+k);
                    ...
                    model.addConstr(expr6, GRB.LESS_EQUAL, expr7, "c_46_"+i+"_"+k);
                    model.addConstr(expr7, GRB.LESS_EQUAL, expr8, "c_47_"+i+"_"+k);
                    ...
                    model.addConstr(parcel_fragility.get(i), GRB.GREATER_EQUAL, fragilityExpr_k, "c_48_"+i+"_"+k);
                }
            }

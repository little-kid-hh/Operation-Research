# Seed1 Offset0-100 Ranker Auto Summary, 2026-07-05

Generated from committed manifest:

```text
python BoxDesignSurrogateRL/scripts/summarize_ranker_window_results.py \
  --manifest BoxDesignSurrogateRL/docs/SEED1_OFFSET0_100_RANKER_RESULT_MANIFEST_20260705.json \
  --total-label "seed1:test[0,200) partial total"
```
...
| seed1:test[0,200) partial total | window-wise | window-wise | 1.0000 | 36900 | 32200 | 3397 | 3134 | 1819.1253 | 1685.9652 | 2511.4663 | 2319.0485 |
...
| seed1:test[0,200) partial total | window-wise | 12.7% | 7.7% | 7.3% | 7.7% |

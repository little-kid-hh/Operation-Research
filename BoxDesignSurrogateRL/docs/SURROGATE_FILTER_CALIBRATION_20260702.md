...
1. Add a missed-candidate audit mode: periodically or on surrogate-filter
   `noop`, validate the full candidate set and record the exact rank of the best
   surrogate-kept candidate.

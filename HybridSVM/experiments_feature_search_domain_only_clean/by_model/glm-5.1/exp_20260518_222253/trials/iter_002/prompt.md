...
- active feature names: `tall_item_share`, `volume_tail_ratio`, `fragile_share`, `flat_item_share`, `dim_l_p90_to_vh`
- active bank AUC: `0.9690`
- active bank TPR@FPR=1%: `0.6416`
- active bank Accuracy: `0.9352`

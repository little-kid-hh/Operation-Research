...
- active feature names: `tall_item_share`, `volume_tail_ratio`, `fragile_share`, `flat_item_share`, `dim_l_p90_to_vh`, `spare_vol_per_item`, `bulky_item_share`, `dim_m_p90_to_vw`, `height_layer_pressure`, `footprint_sum_ratio`, `length_sum_pressure`, `pressure_product`, `max_dim_l_to_min_floor`, `count_vol_fill_interaction`
- active bank AUC: `0.9719`
- active bank TPR@FPR=1%: `0.6534`
- active bank Accuracy: `0.9336`
